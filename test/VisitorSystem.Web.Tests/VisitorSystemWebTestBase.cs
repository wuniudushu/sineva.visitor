...
{
    public abstract class VisitorSystemWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static VisitorSystemWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(VisitorSystemWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<VisitorSystemDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<VisitorSystemDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<VisitorSystemDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<VisitorSystemDbContext, Task<T>> func)
        {
            T result;
